...
```{r}
plot_pangenome_fits(fits, include_data = TRUE, type = 'individual', trim = FALSE, facet = TRUE)
```
...
gg1 <- plot_pangenome_fits(fits, type='cumulative', include_data = TRUE, trim = TRUE, facet = TRUE, color_pallete = 6, text_size = 20) + 
  scale_y_continuous(limits = c(0,1000)) +
  scale_x_continuous(limits = c(0,20))
gg2 <- plot_pangenome_fits(efits, type='cumulative', include_data = TRUE, trim = TRUE, facet = TRUE, color_pallete = 1, text_size = 20) + 
  scale_y_continuous(limits = c(0,1000)) +
  scale_x_continuous(limits = c(0,20))

gg1 + gg2 + patchwork::plot_layout(nrow = 1, guides = 'collect')

pdf <- plot_pangenome_fits(combined_fits, type='cumulative', include_data = TRUE, trim = TRUE, facet = TRUE, plot = FALSE)
...
ggplot2::ggplot(pdf$fit_data, ggplot2::aes(x=.data$core, y=.data$acc, colour=.data$pangenome)) + 
  ...
  ggplot2::scale_colour_brewer(type = 'qual', palette = 3) +
